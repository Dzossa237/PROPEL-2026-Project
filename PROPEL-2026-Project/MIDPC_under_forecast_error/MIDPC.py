...
if __name__=='__main__':
        ...
        _, loads_t_1d, _ = utils.generate_datacenter_load(
        ...
        torch.save(cl_system, rf'C:\\Users\\dzoss\Desktop\\MI-DPC\\results\\MIDPCPolicy3_N_{nsteps}_Ts_{Ts}_M_{init.M}.pt')
        torch.save(training_data, rf'C:\\Users\\dzoss\\Desktop\\MI-DPC\\results\\Trainingdata3_N_{nsteps}_Ts_{Ts}_M_{init.M}.pt')
# %%
